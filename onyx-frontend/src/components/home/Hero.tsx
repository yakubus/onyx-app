...
const Hero = () => {
    return (
        <div className="container max-w-full sm:h-1200px lg:h-680px lg:max-w-1440px p-0 m-0 ml-0 mx-auto lg:ml-122px mt-28 ">
        <div className="grid grid-cols-1 h-1200px lg:h-680px lg:grid-cols-2">
